...
- [Overview](#overview)
  ...
  - [Example](#example)
    - [Usage](#usage)
- [pocketbase_plugin_telegram_auth](#pocketbase_plugin_telegram_auth)
  - [Index](#index)
...
```bash
go get github.com/aboozaid/pocketbase-plugin-telegram-auth
```
...
```go
import "github.com/aboozaid/pocketbase-plugin-telegram-auth"
```
...
## type [Options](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L27-L34)
...
## type [Plugin](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L36-L40)
...
### func [MustRegister](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L99)
...
### func [Register](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L108)
...
### func \(\*Plugin\) [AuthByTelegramData](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L89)
...
### func \(\*Plugin\) [GetCollection](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L60)
...
### func \(\*Plugin\) [GetForm](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L76)
...
### func \(\*Plugin\) [Validate](https://github.com/aboozaid/pocketbase-plugin-telegram-auth/blob/master/plugin.go#L43)
