...
func BenchmarkCheckTelegramAuthorization_WebApp(b *testing.B) {
...
func BenchmarkCheckTelegramAuthorization_Widget(b *testing.B) {
	app, _ := tests.NewTestApp()
	defer app.Cleanup()
...
func BenchmarkGetAuthUserFromData_WebApp(b *testing.B) {
	app, _ := tests.NewTestApp()
	defer app.Cleanup()
...
func BenchmarkGetAuthUserFromData_Widget(b *testing.B) {
	app, _ := tests.NewTestApp()
	defer app.Cleanup()
